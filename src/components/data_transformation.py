...
class TransformerConfig:
    data_dir = os.path.join('artifacts', 'TransformedData')
    transformed_train_data_path: str = os.path.join(data_dir, 'train_data_transformed.csv')
    transformed_test_data_path: str = os.path.join(data_dir, 'test_data_transformed.csv')
